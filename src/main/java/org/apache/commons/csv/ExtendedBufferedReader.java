 ...
 * {@link #read()}. This reader also tracks
 * how many characters have been read with {@link #getPosition()}.
 * </p>
 */
final class ExtendedBufferedReader extends UnsynchronizedBufferedReader {
   ...
   *
   * <p>The Unicode characters are divided into two main ranges:
   * <ul>
   ...
   * This will not include a character read using the {@link #peek()} method. If no
   * character has been read then this will return {@link Constants#UNDEFINED}. 
   ...
   *     (counting characters, not bytes since this is a Reader)
   */
  long getPosition() {
